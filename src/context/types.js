...
// types for comments
export const GET_COMMENTS_OF_A_QUESTION = 'GET_COMMENTS_OF_A_QUESTION';
export const CLEAR_COMMENTS_WHEN_BACK = 'CLEAR_COMMENTS_WHEN_BACK';
