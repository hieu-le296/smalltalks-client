...
const CommentForm = () => {
   ...
   // const commentDispatch = useComment()[1];
    ...
    const postComment = async(e) => {
        ...
        let response = await addComment(commentDispatch,question.questionId,{"content":newCommentValue});
  ...
  <textarea className="form-control" id="newCommentArea" rows="2" ref={newComment}></textarea>
  
</div>
<button type="button" className="btn btn-success mb-3" onClick={postComment}>Post</button><hr/>
        </Fragment>
    )
