    ...
    <Fragment>
      <div className=' d-flex flex-column justify-content-start align-items-center'>
        <div className='align-self-center' style={{ maxWidth: '50%' }}>
          <img
            src={user && `${API_URL}/backgrounds/${user.data.backgroundPic}`}
        ...
        <h1 className='mt-3'>{user && user.data.name}</h1>
      </div>
        ...
        <div className='tab-content'>
          ...
          >
            ...
            <div className='mb-4'>
              ...
              <input type='file' className='form-control' id='backgroundPic' />
              <button className='btn btn-info mt-3' type='submit'>
                Update
              </button>
            </div>
            ...
            <div className='mb-4'>
              To Reset the password. Please click <a href='#!'>here</a>
            </div>
          </div>
        </div>
      </div>
